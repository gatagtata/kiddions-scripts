...
Text("     ~Killa B's Ultimate Unlocker 1.58~  ")
Text(" ~Rewards,Unlocks,Progess,Achievements~")
menu.add_action("Victory", function()
...
menu.add_action("General", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Crimes", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Vehicles", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Combat", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Weapons", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
		...
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH6", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH7", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH8", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH9", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH10", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH11", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH12", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH13", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH14", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH15", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH16", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH17", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH18", -1)
		stats.set_int(mpx .. "WEAP_FM_ADDON_PURCH19", -1)
		...
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE13", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE14", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE15", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE16", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE17", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE18", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE19", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE20", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE21", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE22", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE23", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE24", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE25", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE26", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE27", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE28", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE29", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE30", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE31", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE32", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE33", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE34", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE35", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE36", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE37", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE38", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE39", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE40", -1)
		stats.set_int(mpx .. "CHAR_KIT_FM_PURCHASE41", -1)
		stats.set_int(mpx .. "CHAR_KIT_1_FM_UNLCK", -1)
		stats.set_int(mpx .. "CHAR_KIT_2_FM_UNLCK", -1)
		stats.set_int(mpx .. "CHAR_KIT_3_FM_UNLCK", -1)
		stats.set_int(mpx .. "CHAR_KIT_4_FM_UNLCK", -1)
...
menu.add_action("Heists", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Doomsday", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("After Hours", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Arena War", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Diamond Casino'n'Resort", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Diamond Casino Heist", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Arcade", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
		...
		stats.set_int(mpx .. "SCGW_INITIALS_1", 356361)
		stats.set_int(mpx .. "SCGW_INITIALS_2", 533761)
		stats.set_int(mpx .. "SCGW_INITIALS_3", 861443)
		stats.set_int(mpx .. "SCGW_INITIALS_4", 21638)
		stats.set_int(mpx .. "SCGW_INITIALS_5", 336649)
		stats.set_int(mpx .. "SCGW_INITIALS_5", 586639)
		stats.set_int(mpx .. "SCGW_INITIALS_6", 795603)
		stats.set_int(mpx .. "SCGW_INITIALS_7", 38023)
		stats.set_int(mpx .. "SCGW_INITIALS_8", 341123)
		...
		globals.set_int(262145 + 27964, 1)
		globals.set_int(262145 + 27965, 1)
		globals.set_int(262145 + 27966, 1)
		globals.set_int(262145 + 27967, 1)
		globals.set_int(262145 + 27968, 1)
		globals.set_int(262145 + 27969, 1)
		globals.set_int(262145 + 27970, 1)
		globals.set_int(262145 + 27971, 1)
		globals.set_int(262145 + 27972, 1)
		globals.set_int(262145 + 27973, 1)
		globals.set_int(262145 + 27974, 1)
		globals.set_int(262145 + 27975, 1)
		globals.set_int(262145 + 27976, 1)
		globals.set_int(262145 + 27977, 1)
		globals.set_int(262145 + 27978, 1)
		globals.set_int(262145 + 27979, 1)
		globals.set_int(262145 + 27980, 1)
		globals.set_int(262145 + 27981, 1)
		globals.set_int(262145 + 27982, 1)
		globals.set_int(262145 + 27983, 1)
		globals.set_int(262145 + 27984, 1)
		stats.set_bool_masked(mpx .. "CASINOPSTAT_BOOL",true, 28098, 28354)
		stats.set_bool_masked(mpx .. "CASINOHSTPSTAT_BOOL",true, 28355, 28483)
end)
menu.add_action("LS Summer SpecialDLC", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Cayo PericoDLC", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("LS TunerDLC", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("ContractDLC", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
Text("------------------------------------------------------------------")
menu.add_action("Complete Objectives", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
        ...
        stats.set_int(mpx .. "AWD_DAILYOBJCOMPLETED", 0)
        stats.set_int(mpx .. "AWD_DAILYOBJCOMPLETED", 10)
        stats.set_int(mpx .. "AWD_DAILYOBJCOMPLETED", 25)
        stats.set_int(mpx .. "AWD_DAILYOBJCOMPLETED", 50)
        stats.set_int(mpx .. "AWD_DAILYOBJCOMPLETED", 100)
        stats.set_int(mpx .. "CONSECUTIVEWEEKCOMPLETED", 0)
        stats.set_int(mpx .. "CONSECUTIVEWEEKCOMPLETED", 7)
        stats.set_int(mpx .. "CONSECUTIVEWEEKCOMPLETED", 28)
		stats.set_bool(mpx .. "AWD_DAILYOBJWEEKBONUS", true)
        stats.set_bool(mpx .. "AWD_DAILYOBJMONTHBONUS", true)
end)
menu.add_action("LSCM Prize Ride", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
Text("------------------------------------------------------------------")
menu.add_action("Skip Lamar Missions", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Skip Yacht Missions", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("CEO/MC Money Clutter", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
        ...
        stats.set_int(mpx .. "LIFETIME_CONTRA_EARNINGS", 20000000)
        ...
        stats.set_int(mpx .. "LIFETIME_BKR_SELL_EARNINGS5", 20000000)
		...
		stats.set_int(mpx .. "LFETIME_HANGAR_EARN_BONUS", 1598746)
...
menu.add_action("Unlock Phone Contacts", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Unlock Trade Prices", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Flight School", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Shooting Range Unlocks", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Unlock CLothing", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
		...
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_41", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_42", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_43", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_44", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_45", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_46", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_47", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_48", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_49", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_50", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_51", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_52", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_53", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_54", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_55", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_56", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_57", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_58", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_59", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_60", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_61", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_62", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_63", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_64", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_65", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_66", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_67", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_68", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_69", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_70", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_71", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_72", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_73", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_74", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_75", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_76", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_77", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_78", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_79", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_80", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_81", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_82", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_83", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_84", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_85", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_86", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_87", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_88", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_89", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_90", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_91", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_92", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_93", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_94", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_95", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_96", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_97", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_98", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_99", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_100", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_100", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_101", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_102", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_103", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_104", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_105", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_106", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_107", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_108", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_109", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_110", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_111", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_112", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_113", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_114", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_115", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_116", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_117", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_118", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_119", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_120", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_121", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_122", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_123", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_124", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_125", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_126", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_127", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_128", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_129", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_130", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_131", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_132", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_133", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_134", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_135", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_136", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_137", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_138", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_139", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_140", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_141", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_142", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_143", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_144", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_145", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_146", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_147", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_148", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_149", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_150", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_151", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_152", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_153", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_154", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_155", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_156", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_157", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_158", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_159", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_160", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_161", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_162", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_163", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_164", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_165", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_166", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_167", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_168", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_169", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_170", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_171", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_172", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_173", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_174", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_175", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_176", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_177", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_178", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_179", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_180", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_181", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_182", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_183", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_184", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_185", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_186", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_187", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_188", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_189", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_190", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_191", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_192", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_193", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_194", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_195", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_196", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_197", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_198", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_199", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_200", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_201", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_202", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_203", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_204", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_205", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_206", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_207", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_208", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_209", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_210", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_211", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_212", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_213", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_214", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_215", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_216", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_217", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_218", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_219", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_220", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_221", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_222", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_223", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_224", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_225", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_226", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_227", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_228", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_229", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_230", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_231", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_232", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_233", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_234", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_235", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_236", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_237", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_238", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_239", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_240", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_241", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_242", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_243", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_244", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_245", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_246", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_247", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_248", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_249", -1)
		stats.set_int(mpx .. "DLC_APPAREL_ACQUIRED_250", -1)
end)
menu.add_action("Unlock CLothing 2", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Vanilla Unicorn ", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_int_range("Alien Tattoo M1/F2", 1, 1, 2, function() return 1 end, function(GeN)
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Special Weapons", function()
		stats.set_bool("MPPLY_MELEECHLENGECOMPLETED", true)
		stats.set_bool("MPPLY_HEADSHOTCHLENGECOMPLETED", true)
		stats.set_bool("MPPLY_NAVYREVOLVERCOMPLETED", true)
end)
Text("------------------------------------------------------------------")
menu.add_action("Fast run and reload", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Reset FRR", function()
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
Text("------------------------------------------------------------------")
menu.add_int_range("Time Stats 6D/12D/18D/24D", 1, 1, 4, function() return 1 end, function(TTM)
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
	...
	elseif TTM == 4 then
		...
		stats.set_int("MPPLY_TOTAL_PLAYING_TIME", ATM)
		stats.set_int("MPPLY_LEADERBOARD_PLAYING_TIME", ATM)
		stats.set_int("MPPLY_MP_PLAYING_TIME_NEW", ATM)
		stats.set_int("MPPLY_LONGEST_PLAYING_TIME", ATM)
		stats.set_int("MPPLY_TIME_DRIVING_CAR", ATM)
		stats.set_int("MPPLY_TIME_DRIVING_PLANE", ATM)
		stats.set_int("MPPLY_TIME_DRIVING_HELI", ATM)
		stats.set_int("MPPLY_TIME_DRIVING_QUADBIKE", ATM)
		stats.set_int("MPPLY_TIME_DRIVING_BIKE", ATM)
		stats.set_int("MPPLY_TIME_DRIVING_BICYCLE", ATM)
		stats.set_int("MPPLY_TIME_DRIVING_BOAT", ATM)
		stats.set_int("MPPLY_TIME_DRIVING_SUBMARINE", ATM)
		stats.set_int("MPPLY_TIME_SWIMMING", ATM)
		stats.set_int("MPPLY_TIME_WALKING", ATM)
		stats.set_int("MPPLY_TIME_UNDERWATER", ATM)
		stats.set_int("MPPLY_TIME_IN_WATER", ATM)
		stats.set_int("MPPLY_TIME_IN_COVER", ATM)
		stats.set_int("MPPLY_TIME_DRIVING_PASSENGER", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_SPENT_ON_PHONE", ATM)
		stats.set_int("MPPLY_TIME_AS_A_PASSENGER", ATM)
		stats.set_int("MPPLY_TIME_AS_A_DRIVER", ATM)
		stats.set_int("MPPLY_TIME_SPENT_FLYING", ATM)
		stats.set_int("MPPLY_TIME_IN_CAR", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_SPENT_DEATHMAT", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_SPENT_FREEMODE", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_MISSION_CREATO", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_SPENT_RACES", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_SPENT_ON_MISS", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_UNDERWATER", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_CINEMA", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_LOAD_SCREEN", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_IN_LOBBY", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_SPENT_DEATHMAT", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_SPENT_RACES", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_LOAD_SCREEN", ATM)
		stats.set_int("MPPLY_TOTAL_TIME_IN_LOBBY", ATM)
		stats.set_int(mpx .. "TIME_AS_A_DRIVER", ATM)
		stats.set_int(mpx .. "TIME_SPENT_FLYING", ATM)
		stats.set_int(mpx .. "TIME_IN_CAR", ATM)
		stats.set_int(mpx .. "TIME_AS_A_PASSENGER", ATM)
		stats.set_int(mpx .. "TOTAL_TIME_CINEMA", ATM)
		stats.set_int(mpx .. "TOTAL_CHASE_TIME", 432000000)
		stats.set_int(mpx .. "ARN_SPEC_BOX_TIME_MS", 86400000)
		stats.set_int(mpx .. "LONGEST_PLAYING_TIME", ATM)
		stats.set_int(mpx .. "TIME_DRIVING_CAR", ATM)
		stats.set_int(mpx .. "TIME_DRIVING_PLANE", ATM)
		stats.set_int(mpx .. "TIME_DRIVING_HELI", ATM)
		stats.set_int(mpx .. "TIME_DRIVING_QUADBIKE", ATM)
		stats.set_int(mpx .. "TIME_DRIVING_BIKE", ATM)
		stats.set_int(mpx .. "TIME_DRIVING_BICYCLE", ATM)
		stats.set_int(mpx .. "TIME_DRIVING_BOAT", ATM)
		stats.set_int(mpx .. "TIME_DRIVING_SUBMARINE", ATM)
		stats.set_int(mpx .. "TIME_SWIMMING", ATM)
		stats.set_int(mpx .. "TIME_WALKING", ATM)
		stats.set_int(mpx .. "TIME_UNDERWATER", ATM)
		stats.set_int(mpx .. "TIME_IN_WATER", ATM)
		stats.set_int(mpx .. "TIME_IN_COVER", ATM)
		stats.set_int(mpx .. "TIME_DRIVING_PASSENGER", ATM)
		stats.set_int(mpx .. "TOTAL_TIME_SPENT_ON_PHONE", ATM)
end)
menu.add_int_range("Vehicle Stats-DoEachNo.", 1, 1, 7, function() return 1 end, function(VehH)
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_int_range("Weapon Stats-DoEachNo.", 1, 1, 3, function() return 1 end, function(WepH)
	PlayerIndex = globals.get_int(1574907)
	if PlayerIndex == 0 then
		mpx = "MP0_"
	else
...
menu.add_action("Returning Player Bonus", function()
		globals.set_int(151754, 2)
		globals.set_int(102905, 90)
		globals.set_int(102906, 1)
end)
menu.add_action("ContractDLC GunSkins", function()
		globals.set_int(286132, 1)
		globals.set_int(286133, 1)
end)
menu.add_action("ContractDLC Animal Masks", function()
		globals.set_int(262145 + 31437, 1)
		globals.set_int(262145 + 31438, 1)
		globals.set_int(262145 + 31439, 1)
		globals.set_int(262145 + 31440, 1)
		globals.set_int(262145 + 31441, 1)
		globals.set_int(262145 + 31442, 1)
		globals.set_int(262145 + 31443, 1)
		globals.set_int(262145 + 31444, 1)
		globals.set_int(262145 + 31445, 1)
		globals.set_int(262145 + 31446, 1)
		globals.set_int(262145 + 31447, 1)
		globals.set_int(262145 + 31448, 1)
end)
menu.add_action("ContractDLC DJ Cloths", function()
		globals.set_int(262145 + 31449, 1)
		globals.set_int(262145 + 31450, 1)
		globals.set_int(262145 + 31451, 1)
end)
...
menu.add_action("Arena Clothing", function()
		globals.set_int(262145 + 25490,1)
        globals.set_int(262145 + 25491,1)
        globals.set_int(262145 + 25492,1)
        globals.set_int(262145 + 25493,1)
        globals.set_int(262145 + 25494,1)
        globals.set_int(262145 + 25495,1)
        globals.set_int(262145 + 25496,1)
        globals.set_int(262145 + 25497,1)
        globals.set_int(262145 + 25498,1)
        globals.set_int(262145 + 25499,1)
        globals.set_int(262145 + 25500,1)
        globals.set_int(262145 + 25501,1)
        globals.set_int(262145 + 25502,1)
        globals.set_int(262145 + 25503,1)
        globals.set_int(262145 + 25504,1)
        globals.set_int(262145 + 25505,1)
        globals.set_int(262145 + 25506,1)
        globals.set_int(262145 + 25507,1)
        globals.set_int(262145 + 25508,1)
        globals.set_int(262145 + 25509,1)
        globals.set_int(262145 + 25510,1)
        globals.set_int(262145 + 25511,1)
        globals.set_int(262145 + 25512,1)
        globals.set_int(262145 + 25513,1)
        globals.set_int(262145 + 25514,1)
        globals.set_int(262145 + 25515,1)
        globals.set_int(262145 + 25516,1)
        globals.set_int(262145 + 25517,1)
        globals.set_int(262145 + 25518,1)
        globals.set_int(262145 + 25519,1)
        globals.set_int(262145 + 25520,1)
        globals.set_int(262145 + 25521,1)
        globals.set_int(262145 + 25522,1)
        globals.set_int(262145 + 25523,1)
        globals.set_int(262145 + 25524,1)
        globals.set_int(262145 + 25525,1)
        globals.set_int(262145 + 25526,1)
        globals.set_int(262145 + 25527,1)
        globals.set_int(262145 + 25528,1)
        globals.set_int(262145 + 25529,1)
        globals.set_int(262145 + 25530,1)
        globals.set_int(262145 + 25531,1)
        globals.set_int(262145 + 25532,1)
        globals.set_int(262145 + 25533,1)
        globals.set_int(262145 + 25534,1)
        globals.set_int(262145 + 25535,1)
        globals.set_int(262145 + 25536,1)
        globals.set_int(262145 + 25537,1)
        globals.set_int(262145 + 25538,1)
        globals.set_int(262145 + 25539,1)
        globals.set_int(262145 + 25540,1)
        globals.set_int(262145 + 25541,1)
        globals.set_int(262145 + 25542,1)
        globals.set_int(262145 + 25543,1)
        globals.set_int(262145 + 25544,1)
        globals.set_int(262145 + 25545,1)
        globals.set_int(262145 + 25546,1)
        globals.set_int(262145 + 25547,1)
        globals.set_int(262145 + 25548,1)
        globals.set_int(262145 + 25549,1)
        globals.set_int(262145 + 25550,1)
        globals.set_int(262145 + 25551,1)
        globals.set_int(262145 + 25552,1)
        globals.set_int(262145 + 25553,1)
        globals.set_int(262145 + 25554,1)
        globals.set_int(262145 + 25555,1)
        globals.set_int(262145 + 25556,1)
        globals.set_int(262145 + 25557,1)
        globals.set_int(262145 + 25558,1)
end)
menu.add_action("LS Summer Stuff", function()
		globals.set_int(262145 + 29333,1)
        globals.set_int(262145 + 29334,1)
        globals.set_int(262145 + 29335,1)
        globals.set_int(262145 + 29336,1)
        globals.set_int(262145 + 29337,1)
        globals.set_int(262145 + 29338,1)
        globals.set_int(262145 + 29339,1)
        globals.set_int(262145 + 29340,1)
        globals.set_int(262145 + 29341,1)
        globals.set_int(262145 + 29342,1)
        globals.set_int(262145 + 29343,1)
        globals.set_int(262145 + 29344,1)
        globals.set_int(262145 + 29345,1)
        globals.set_int(262145 + 29346,1)
        globals.set_int(262145 + 29347,1)
        globals.set_int(262145 + 29348,1)
        globals.set_int(262145 + 29349,1)
        globals.set_int(262145 + 29350,1)
        globals.set_int(262145 + 29351,1)
        globals.set_int(262145 + 29352,1)
        globals.set_int(262145 + 29353,1)
        globals.set_int(262145 + 29354,1)
        globals.set_int(262145 + 29355,1)
        globals.set_int(262145 + 29356,1)
        globals.set_int(262145 + 29357,1)
        globals.set_int(262145 + 29358,1)
        globals.set_int(262145 + 29359,1)
        globals.set_int(262145 + 29360,1)
        globals.set_int(262145 + 29361,1)
        globals.set_int(262145 + 29362,1)
        globals.set_int(262145 + 29363,1)
        globals.set_int(262145 + 29364,1)
        globals.set_int(262145 + 29365,1)
        globals.set_int(262145 + 29366,1)
        globals.set_int(262145 + 29366,1)
        globals.set_int(262145 + 29367,1)
        globals.set_int(262145 + 29368,1)
end)
menu.add_action("LS Tuners Stuff", function()
		globals.set_int(262145 + 30817, 1)
        globals.set_int(262145 + 30818, 1)
        globals.set_int(262145 + 30819, 1)
        globals.set_int(262145 + 30820, 1)
        globals.set_int(262145 + 30821, 1)
        globals.set_int(262145 + 30822, 1)
        globals.set_int(262145 + 30823, 1)
        globals.set_int(262145 + 30824, 1)
        globals.set_int(262145 + 30825, 1)
        globals.set_int(262145 + 30826, 1)
        globals.set_int(262145 + 30827, 1)
        globals.set_int(262145 + 30828, 1)
        globals.set_int(262145 + 30829, 1)
        globals.set_int(262145 + 30830, 1)
        globals.set_int(262145 + 30831, 1)
        globals.set_int(262145 + 30832, 1)
        globals.set_int(262145 + 30833, 1)
        globals.set_int(262145 + 30834, 1)
        globals.set_int(262145 + 30835, 1)
        globals.set_int(262145 + 30836, 1)
        globals.set_int(262145 + 30837, 1)
        globals.set_int(262145 + 30838, 1)
        globals.set_int(262145 + 30839, 1)
        globals.set_int(262145 + 30653, 1)
        globals.set_int(262145 + 30654, 1)
        globals.set_int(262145 + 30655, 1)
        globals.set_int(262145 + 30656, 1)
        globals.set_int(262145 + 30657, 1)
        globals.set_int(262145 + 30658, 1)
        globals.set_int(262145 + 30659, 1)
        globals.set_int(2863548,0)
end)
menu.add_action("Arcade Clothing", function()
		globals.set_int(262145 + 27964,1)
		globals.set_int(262145 + 27965,1)
		globals.set_int(262145 + 27966,1)
		globals.set_int(262145 + 27967,1)
